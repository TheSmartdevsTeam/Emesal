...
namespace UnityStandardAssets.Water
{
    ...
    public class WaterBaseEditorScript : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!oceanMaterial)
            {
                sharedMaterial.objectReferenceValue = (Object)WaterEditorUtilityScript.LocateValidWaterMaterial(oceanBase.transform);
            ...
            WaterEditorUtilityScript.SetMaterialColor("_BaseColor", EditorGUILayout.ColorField("Refraction", WaterEditorUtilityScript.GetMaterialColor("_BaseColor", oceanMaterial)), oceanMaterial);
            WaterEditorUtilityScript.SetMaterialColor("_ReflectionColor", EditorGUILayout.ColorField("Reflection", WaterEditorUtilityScript.GetMaterialColor("_ReflectionColor", oceanMaterial)), oceanMaterial);
            ...
            WaterEditorUtilityScript.SetMaterialTexture("_BumpMap", (Texture)EditorGUILayout.ObjectField("Normals", WaterEditorUtilityScript.GetMaterialTexture("_BumpMap", waterBase.sharedMaterial), typeof(Texture), false), waterBase.sharedMaterial);
            if (hasShore)
                WaterEditorUtilityScript.SetMaterialTexture("_ShoreTex", (Texture)EditorGUILayout.ObjectField("Shore & Foam", WaterEditorUtilityScript.GetMaterialTexture("_ShoreTex", waterBase.sharedMaterial), typeof(Texture), false), waterBase.sharedMaterial);
            ...
            animationTiling = WaterEditorUtilityScript.GetMaterialVector("_BumpTiling", oceanMaterial);
            animationDirection = WaterEditorUtilityScript.GetMaterialVector("_BumpDirection", oceanMaterial);
            ...
            WaterEditorUtilityScript.SetMaterialVector("_BumpTiling", animationTiling, oceanMaterial);
            WaterEditorUtilityScript.SetMaterialVector("_BumpDirection", animationDirection, oceanMaterial);

            Vector4 displacementParameter = WaterEditorUtilityScript.GetMaterialVector("_DistortParams", oceanMaterial);
            Vector4 fade = WaterEditorUtilityScript.GetMaterialVector("_InvFadeParemeter", oceanMaterial);
            ...
            float gerstnerNormalIntensity = WaterEditorUtilityScript.GetMaterialFloat("_GerstnerIntensity", oceanMaterial);
            gerstnerNormalIntensity = EditorGUILayout.Slider("Per Vertex", gerstnerNormalIntensity, -2.5F, 2.5F);
            WaterEditorUtilityScript.SetMaterialFloat("_GerstnerIntensity", gerstnerNormalIntensity, oceanMaterial);
            ...
            if (!oceanMaterial.HasProperty("_Fresnel"))
            {
                ...
                {
                    float fresnelScale = EditorGUILayout.Slider("Intensity", WaterEditorUtilityScript.GetMaterialFloat("_FresnelScale", oceanMaterial), 0.1F, 4.0F);
                    WaterEditorUtilityScript.SetMaterialFloat("_FresnelScale", fresnelScale, oceanMaterial);
                }
            ...
            else
            {
                Texture fresnelTex = (Texture)EditorGUILayout.ObjectField(
                        "Ramp",
                        (Texture)WaterEditorUtilityScript.GetMaterialTexture("_Fresnel",
                        oceanMaterial),
                        typeof(Texture),
                        false);
                WaterEditorUtilityScript.SetMaterialTexture("_Fresnel", fresnelTex, oceanMaterial);
            }

            EditorGUILayout.Separator();

            WaterEditorUtilityScript.SetMaterialVector("_DistortParams", displacementParameter, oceanMaterial);
            ...
            if (edgeBlend.boolValue)
            {
                ...
                WaterEditorUtilityScript.SetMaterialVector("_InvFadeParemeter", fade, oceanMaterial);
            }
            EditorGUILayout.Separator();
            ...
            if (oceanMaterial.HasProperty("_Foam"))
            {
                ...
                Vector4 foam = WaterEditorUtilityScript.GetMaterialVector("_Foam", oceanMaterial);

                foam.x = EditorGUILayout.Slider("Intensity", foam.x, 0.0F, 1.0F);
                foam.y = EditorGUILayout.Slider("Cutoff", foam.y, 0.0F, 1.0F);

                WaterEditorUtilityScript.SetMaterialVector("_Foam", foam, oceanMaterial);
            }
