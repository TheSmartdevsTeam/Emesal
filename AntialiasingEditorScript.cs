...
/*
[CustomEditor(typeof(AntialiasingScript))]
public class AntialiasingEditorScript : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        /*
        Material mat = (target as AntialiasingScript).CurrentAAMaterial();
        if (null == mat && (target as AntialiasingScript).enabled)
        {
