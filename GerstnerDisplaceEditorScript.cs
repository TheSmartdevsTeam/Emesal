...
namespace UnityStandardAssets.Water
{
    ...
    public class GerstnerDisplaceEditorScript : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                Vector4 amplitude = WaterEditorUtilityScript.GetMaterialVector("_GAmplitude", sharedWaterMaterial);
                Vector4 frequency = WaterEditorUtilityScript.GetMaterialVector("_GFrequency", sharedWaterMaterial);
                Vector4 steepness = WaterEditorUtilityScript.GetMaterialVector("_GSteepness", sharedWaterMaterial);
                Vector4 speed = WaterEditorUtilityScript.GetMaterialVector("_GSpeed", sharedWaterMaterial);
                Vector4 directionAB = WaterEditorUtilityScript.GetMaterialVector("_GDirectionAB", sharedWaterMaterial);
                Vector4 directionCD = WaterEditorUtilityScript.GetMaterialVector("_GDirectionCD", sharedWaterMaterial);
                ...
                if (GUI.changed)
                {
                    WaterEditorUtilityScript.SetMaterialVector("_GAmplitude", amplitude, sharedWaterMaterial);
                    WaterEditorUtilityScript.SetMaterialVector("_GFrequency", frequency, sharedWaterMaterial);
                    WaterEditorUtilityScript.SetMaterialVector("_GSteepness", steepness, sharedWaterMaterial);
                    WaterEditorUtilityScript.SetMaterialVector("_GSpeed", speed, sharedWaterMaterial);
                    WaterEditorUtilityScript.SetMaterialVector("_GDirectionAB", directionAB, sharedWaterMaterial);
                    WaterEditorUtilityScript.SetMaterialVector("_GDirectionCD", directionCD, sharedWaterMaterial);
                }
