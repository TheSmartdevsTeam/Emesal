...
{/*
    ...
    public class SpecularLightingEditorScript : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (wb.sharedMaterial.HasProperty("_WorldLightDir"))
            {
                ...
                if (wb.sharedMaterial.HasProperty("_SpecularColor"))
                    WaterEditorUtilityScript.SetMaterialColor(
                        "_SpecularColor",
                        EditorGUILayout.ColorField("Specular",
                        WaterEditorUtilityScript.GetMaterialColor("_SpecularColor", wb.sharedMaterial)),
                        wb.sharedMaterial);
                if (wb.sharedMaterial.HasProperty("_Shininess"))
                    WaterEditorUtilityScript.SetMaterialFloat("_Shininess", EditorGUILayout.Slider(
                        "Specular power",
                        WaterEditorUtilityScript.GetMaterialFloat("_Shininess", wb.sharedMaterial),
